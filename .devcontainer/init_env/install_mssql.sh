...
echo -e "extension=pdo_sqlsrv.so" | sudo tee /etc/php/8.4/mods-available/pdo_sqlsrv.ini
echo -e "extension=sqlsrv.so" | sudo tee /etc/php/8.4/mods-available/sqlsrv.ini

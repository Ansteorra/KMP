...
5. **Commit `.ai-team/` changes:**
   ...
   - Write commit message to a temp file, then `git commit -F <tmpfile>`
...
└── agents/
    ├── mal/history.md    # Mal's personal knowledge
    ├── kaylee/history.md # Kaylee's personal knowledge
    ├── wash/history.md   # Wash's personal knowledge
    └── jayne/history.md  # Jayne's personal knowledge
```

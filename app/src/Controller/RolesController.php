...
class RolesController extends AppController
{
    ...
    public function view($id = null)
    {
        ...
        $role = $this->Roles->get($id,contain: ['MemberRoles.Members','MemberRoles.Approved_By','Permissions.AuthorizationTypes','Permissions']);
    ...
    {
        $role = $this->Roles->get($id,contain: ['MemberRoles.Members','MemberRoles.Approved_By','Permissions']);

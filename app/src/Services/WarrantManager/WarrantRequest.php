...
class WarrantRequest
{
    ...
    public function __construct(string $entity_type, int $entity_id, int $requester_id, int $member_id, DateTime $start_on = null, DateTime $expires_on = null, ?int $member_role_id = null)
    {

...
class KmpHelper extends Helper
{
    ...
    public function comboBoxControl($Form, $inputField, $resultField, $data, $label, $required, $allowOtherValues, $additionalAttrs): void
    {
    ...
    public function autoCompleteControl($Form, $inputField, $resultField, $url, $label, $required, $allowOtherValues, $minLength, $additionalAttrs): void
    {
     ...
     * @return string
     */
    public function appNav(array $appNav, Member $user, HtmlHelper $Html, $Url, $navBarState): string
    {
        if (!$navBarState) {
            $navBarState = [];
        }
        ...
        if ($user->canAccessUrl($url)) {
            ...
            if (isset($link['badgeValue'])) {
                if (
                    ...
                    $badgeValue = call_user_func([$class, $method], $argument);
                } else {

...
class TimezoneHelper extends Helper
{
    ...
    /**
     * Format a datetime in user's timezone (or gathering's timezone if provided)
     *
     * @param \Cake\I18n\DateTime|string|null $datetime UTC datetime to format
     * @param string|null $format PHP date format (null = default display format)
    ...
    public function format(
        ...
        // Convert to appropriate timezone (gathering takes priority)

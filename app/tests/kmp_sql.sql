...
--
-- Name: awards_recommendation_state_field_rules; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.awards_recommendation_state_field_rules (
    id integer NOT NULL,
    state_id integer NOT NULL,
    field_target character varying(255) NOT NULL,
...
--
-- Name: awards_recommendation_state_field_rules_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.awards_recommendation_state_field_rules ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.awards_recommendation_state_field_rules_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: awards_recommendation_state_transitions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.awards_recommendation_state_transitions (
    id integer NOT NULL,
...
--
-- Name: awards_recommendation_state_transitions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.awards_recommendation_state_transitions ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.awards_recommendation_state_transitions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: awards_recommendation_states; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.awards_recommendation_states (
    id integer NOT NULL,
    status_id integer NOT NULL,
    name character varying(255) NOT NULL,
    sort_order integer DEFAULT 0 NOT NULL,
    supports_gathering boolean DEFAULT false NOT NULL,
...
--
-- Name: awards_recommendation_states_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.awards_recommendation_states ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.awards_recommendation_states_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: awards_recommendation_statuses; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.awards_recommendation_statuses (
    id integer NOT NULL,
    name character varying(255) NOT NULL,
    sort_order integer DEFAULT 0 NOT NULL,
    created timestamp without time zone NOT NULL,
...
--
-- Name: awards_recommendation_statuses_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.awards_recommendation_statuses ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.awards_recommendation_statuses_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: awards_recommendation_state_field_rules awards_recommendation_state_field_rules_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.awards_recommendation_state_field_rules
    ADD CONSTRAINT awards_recommendation_state_field_rules_pkey PRIMARY KEY (id);


--
-- Name: awards_recommendation_state_transitions awards_recommendation_state_transitions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.awards_recommendation_state_transitions
    ADD CONSTRAINT awards_recommendation_state_transitions_pkey PRIMARY KEY (id);


--
-- Name: awards_recommendation_states awards_recommendation_states_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.awards_recommendation_states
    ADD CONSTRAINT awards_recommendation_states_pkey PRIMARY KEY (id);


--
-- Name: awards_recommendation_statuses awards_recommendation_statuses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.awards_recommendation_statuses
    ADD CONSTRAINT awards_recommendation_statuses_pkey PRIMARY KEY (id);
...
--
-- Name: idx_rec_states_deleted; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rec_states_deleted ON public.awards_recommendation_states USING btree (deleted);


--
-- Name: idx_rec_states_name; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_rec_states_name ON public.awards_recommendation_states USING btree (name);


--
-- Name: idx_rec_statuses_deleted; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rec_statuses_deleted ON public.awards_recommendation_statuses USING btree (deleted);


--
-- Name: idx_rec_statuses_name; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_rec_statuses_name ON public.awards_recommendation_statuses USING btree (name);
...
--
-- Name: idx_state_field_rule_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_state_field_rule_unique ON public.awards_recommendation_state_field_rules USING btree (state_id, field_target, rule_type);


--
-- Name: idx_state_transition_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_state_transition_unique ON public.awards_recommendation_state_transitions USING btree (from_state_id, to_state_id);
...
--
-- Name: awards_recommendation_state_field_rules awards_recommendation_state_field_rules_state_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.awards_recommendation_state_field_rules
    ADD CONSTRAINT awards_recommendation_state_field_rules_state_id_fkey FOREIGN KEY (state_id) REFERENCES public.awards_recommendation_states(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: awards_recommendation_state_transitions awards_recommendation_state_transitions_from_state_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.awards_recommendation_state_transitions
    ADD CONSTRAINT awards_recommendation_state_transitions_from_state_id_fkey FOREIGN KEY (from_state_id) REFERENCES public.awards_recommendation_states(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: awards_recommendation_state_transitions awards_recommendation_state_transitions_to_state_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.awards_recommendation_state_transitions
    ADD CONSTRAINT awards_recommendation_state_transitions_to_state_id_fkey FOREIGN KEY (to_state_id) REFERENCES public.awards_recommendation_states(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: awards_recommendation_states awards_recommendation_states_status_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.awards_recommendation_states
    ADD CONSTRAINT awards_recommendation_states_status_id_fkey FOREIGN KEY (status_id) REFERENCES public.awards_recommendation_statuses(id) ON UPDATE CASCADE ON DELETE RESTRICT;

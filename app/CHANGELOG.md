...
- **Email this view** sends a summary of up to 50 matching rows and a link from My Approvals, My To-Dos, Warrant Rosters, and Bestowals daily, every three days, or weekly. **Send me a sample** sends the current view immediately without creating or changing a subscription. Empty scheduled results are skipped. Manage or cancel subscriptions from your profile; deliveries use current permissions and stop when account or view access is lost.
...
- Bestowal tasks awaiting a gathering or court assignment show completion guidance instead of incorrectly saying the task is not assigned to you.

...
- Native passkeys replace quick-login PINs. Manage passkeys from your account; password login and recovery remain available. Offline device setup now uses explicit steps, cancellation and time limits.

...
- Login now starts with your email address, with password entry and optional passkey sign-in on the next step. A remembered ID skips the email step. Supported browsers can suggest saved passkeys automatically.

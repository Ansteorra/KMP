        ...
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar pt-5" style="overflow-y: auto">
                ...
                <nav class="nav flex-column nav-underline mx-2">
                    <?php
                        $appNav = [
                            ['type' => 'parent', 'label' => 'Members', 'icon' => 'bi-people', 'children' => [
                                ['type' => 'link', 'label' => $user->sca_name, 'url' => ['controller' => 'Members', 'action' => 'view', $user->id], 'icon' => 'bi-person-fill',
                                    'activeUrls' =>
                                        [
                                    ...
                                    'sublinks' => [
                                        ...
                                        ['label' => 'My Auth Queue', 'url' => ['controller' => 'AuthorizationApprovals', 'action' => 'myQueue'], 'icon' => 'bi-person-fill-check']
                                    ]],
                                ['type' => 'link', 'label' => 'Members', 'url' => ['controller' => 'Members', 'action' => 'index'], 'icon' => 'bi-people',
                                    'activeUrls' =>
                                        [
                            ...
                            ['type' => 'parent', 'label' => 'System Config', 'icon' => 'bi-database-gear', 'children' => [
                                ...
                                ['type' => 'link', 'label' => 'Branches', 'url' => ['controller' => 'Branches', 'action' => 'index'], 'icon' => 'bi-diagram-3',
                                    'activeUrls' =>
                                        [
                                    ...
                                    'sublinks' => [
                                        ['label' => 'New Branch', 'url' => ['controller' => 'Branches', 'action' => 'add'], 'icon' => 'bi-plus']
                                    ]],
                                ['type' => 'link', 'label' => 'Authorization Groups', 'url' => ['controller' => 'AuthorizationGroups', 'action' => 'index'], 'icon' => 'bi-archive',
                                    'activeUrls' =>
                                        [
                                            ['controller' => 'AuthorizationGroups', 'action' => 'index', '*'],
                                            ['controller' => 'AuthorizationGroups', 'action' => 'add', '*'],
                                            ['controller' => 'AuthorizationGroups', 'action' => 'view', '*']
                                        ],
                                    'sublinks' => [
                                        ['label' => 'New Auth Group', 'url' => ['controller' => 'AuthorizationGroups', 'action' => 'add'], 'icon' => 'bi-plus']
                                    ]],
                                ['type' => 'link', 'label' => 'Authorization Types', 'url' => ['controller' => 'AuthorizationTypes', 'action' => 'index'], 'icon' => 'bi-collection',
                                    'activeUrls' =>
                                        [
                                            ['controller' => 'AuthorizationTypes', 'action' => 'index', '*'],
                                            ['controller' => 'AuthorizationTypes', 'action' => 'add', '*'],
                                            ['controller' => 'AuthorizationTypes', 'action' => 'view', '*']
                                        ],
                                    'sublinks' => [
                                        ['label' => 'New Auth Type', 'url' => ['controller' => 'AuthorizationTypes', 'action' => 'add'], 'icon' => 'bi-plus']
                                    ]]
                            ]],
                            [
                                'type' => 'parent',
                                ...
                                'icon' => 'bi-house-lock',
                                'children' => [
                                    ['type' => 'link', 'label' => 'Roles', 'url' => ['controller' => 'Roles', 'action' => 'index'], 'icon' => 'bi-universal-access-circle',
                                        'activeUrls' =>
                                            [
                                        ...
                                        'sublinks' => [
                                            ['label' => 'New Role', 'url' => ['controller' => 'Roles', 'action' => 'add'], 'icon' => 'bi-plus']
                                        ]],
                                    ['type' => 'link', 'label' => 'Permissions', 'url' => ['controller' => 'Permissions', 'action' => 'index'], 'icon' => 'bi-clipboard-check',
                                        'activeUrls' =>
                                            [
                                                ['controller' => 'Permissions', 'action' => 'index', '*'],
                                                ['controller' => 'Permissions', 'action' => 'add', '*'],
                                                ['controller' => 'Permissions', 'action' => 'view', '*']
                                            ],
                                        'sublinks' => [
                                            ['label' => 'New Permission', 'url' => ['controller' => 'Permissions', 'action' => 'add'], 'icon' => 'bi-plus']
                                        ]]
                                ],
                            ]
                        ];
                        echo $this->Kmp->appNav($appNav, $this->request, $user, $this->Html);
                    ?>
                </nav>
                </div>
            </nav>

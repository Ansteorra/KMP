 ...
 */
if (Configure::read('debug')) {
    $this->prepend('script', $this->Html->script(['https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js','BootstrapUI.popper', 'BootstrapUI.bootstrap']));
} else {
    $this->prepend('script', $this->Html->script(['https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js','BootstrapUI.popper.min', 'BootstrapUI.bootstrap.min']));
}

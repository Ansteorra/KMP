...
<button class="nav-link" id="nav-assignedMembers-tab" data-bs-toggle="tab" data-bs-target="#nav-assignedMembers" type="button" role="tab" aria-controls="nav-assignedMembers" aria-selected="false"><?= __("Assigned Members") ?>
</button>
<button class="nav-link" id="nav-rolePermissions-tab" data-bs-toggle="tab" data-bs-target="#nav-rolePermissions" type="button" role="tab" aria-controls="nav-rolePermissions" aria-selected="false"><?= __("Permissions") ?>
</button>
<?php $this->KMP->endBlock() ?>
<?php $this->KMP->startBlock("tabContent") ?>
<div class="related tab-pane fade m-3" id="nav-assignedMembers" role="tabpanel" aria-labelledby="nav-assignedMembers-tab">
    <button type="button" class="btn btn-primary btn-sm mb-3" data-bs-toggle="modal" data-bs-target="#addMemberModal">Add
        Member</button>
...
<div class="related tab-pane fade m-3" id="nav-rolePermissions" role="tabpanel" aria-labelledby="nav-rolePermissions-tab">
    <button type="button" class="btn btn-primary btn-sm mb-3" data-bs-toggle="modal" data-bs-target="#addPermissionModal">Add
        Permission</button>

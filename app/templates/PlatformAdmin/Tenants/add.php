...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mb-3">
    <div>
        ...
        <p class="text-muted mb-0"><?= __('Create the platform registry and queue full database provisioning and migrations.') ?></p>
    </div>
    <?= $this->Html->link(
        __('Back to tenants'),
...
<?= $this->Form->hidden('nonce', ['value' => Cake\Utility\Text::uuid()]) ?>
...
<div class="d-flex gap-2">
    <?= $this->Form->button(__('Create and queue provisioning'), ['class' => 'btn btn-primary']) ?>
    <?= $this->Html->link(
        __('Cancel'),
        ['prefix' => 'PlatformAdmin', 'controller' => 'Tenants', 'action' => 'index'],
        ['class' => 'btn btn-outline-secondary'],

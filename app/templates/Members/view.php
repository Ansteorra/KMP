    ...
    <div class="table-responsive">
        <table class="table table-striped">
            ...
            <tr scope="row">
                ...
                <td lass="col-10">
                    <?= h($member->membership_number) ?> Exp: <?= h(
            ...
            <tr scope="row">
                ...
                <td lass="col-10"><?= h($member->first_name) ?> <?= h(
                                                                    $member->middle_name,
                                                                ) ?>
                    <?= h($member->last_name) ?>
                </td>
                        ...
                        <table class="table table-striped">
                            ...
                            <?php foreach ($approved as $auth) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#renewalModal" onclick="$('#renew_auth__id').val('<?= $auth->id ?>')">Renew</button>
                                        <?php if (
                                            $user->can("revoke", "Authorizations")
                                        ) { ?>

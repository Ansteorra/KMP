...
echo $this->KMP->getAppSetting("KMP.ShortSiteTitle", "KMP") . ': New Members Verifcation Queue';
$this->KMP->endBlock();
...
<div class="tab-content" id="nav-tabContent">
    <div class="tab-pane fade active" id="nav-youth-tab" role="tabpanel" aria-labelledby="nav-youth-tab-btn"
        tabindex=" 0">

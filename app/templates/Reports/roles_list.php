...
echo $this->KMP->getAppSetting("KMP.ShortSiteTitle") . ': Role Assignments Report';
$this->KMP->endBlock();
        ...
        <?php if ($role->member_roles) : ?>
            <table class="table table-striped table-condensed">
                ...
                <?php foreach ($role->member_roles as $assignment) {
                    $memberExpDate = $assignment->member->membership_expires_on ? $this->Timezone->format($assignment->member->membership_expires_on, $assignment->member, null, \IntlDateFormatter::SHORT) : '';
                    $roleExpDate = $assignment->expires_on ? $this->Timezone->format($assignment->expires_on, null, null, \IntlDateFormatter::SHORT) : '';
                ...
                ?>
                    <?php if ($memExpired) : ?>
                        ...
                        <td><?= $this->Timezone->format($assignment->start_on, null, null, \IntlDateFormatter::SHORT) ?></td>
                        <td><?= h($roleExpDate) ?></td>

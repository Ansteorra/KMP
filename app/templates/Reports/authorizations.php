...
<div class="row">
    ...
    <div class="col-lg-9 col-md-9 columns">
        ...
        <dl>
            ...
            <?php if ($auth->authorization_type_id != $currentAuth) : ?>
            <?php if ($currentAuth != -1) : ?>
            </table>
            <?php endif; ?>
            <?php $currentAuth = $auth->authorization_type_id ?>
            <h3><?= h($auth->authorization_type->name) ?></h3>
                ...
                <tr>
                    <td>
                        <?= $this->Html->link(
                                    ...
                                    ['controller' => 'Members', 'action' => 'view', $auth->member->id]
                                ) ?>
                    </td>

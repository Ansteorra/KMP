                        ...
                        <tr>
                            ...
                            <td class="actions text-end text-nowrap">
                                <?php if ($warrant->status == Warrant::PENDING_STATUS && $user->checkCan("decline", "WarrantRosters")) :
                                    if (!$userApprovedAlready): ?>
                                        <?= $this->Form->postLink(__('Decline'), ['controller' => 'WarrantRosters', 'action' => 'declineWarrantInRoster', $warrantRoster->id, $warrant->id], ['confirm' => __('Declining this warrant will release ' . $warrant->member->sca_name . ' from their office'), 'class' => 'btn-sm btn btn-danger']) ?>
                                    <?php endif ?>
                                <?php endif ?>
                            </td>
                        </tr>
                ...
                <table class="table table-striped">
                    ...
                    <?php foreach ($warrantRoster->warrant_roster_approvals as $warrantRosterApprovals): ?>
                        <tr>
                            ...
                            <td><?= $this->Timezone->format($warrantRosterApprovals->approved_on, null, null, \IntlDateFormatter::SHORT) ?></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
            </div>

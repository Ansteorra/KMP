    ...
    <nav>
        <div class="nav nav-tabs" id="nav-<?= $tabGroupName ?>" role="tablist">
            <?php foreach ($tabs as &$tab) { ?>
                <button class="nav-link<?= $tab["selected"] ? ' active' : '' ?>" id="nav-<?= $tab["id"] ?>-tab" data-bs-toggle="tab"
                    data-bs-target="#nav-<?= $tab["id"] ?>" type="button" role="tab" data-level="activityWindow"
                    aria-controls="nav-<?= $tab["id"] ?>" aria-selected="<?= $tab["selected"] ? 'true' : 'false' ?>"
    ...
    <div class="tab-content" id="nav-tabContent">
        <?php foreach ($tabs as &$tab) { ?>
            <div class="tab-pane fade<?= $tab["selected"] ? ' show active' : '' ?>" id="nav-<?= $tab["id"] ?>" role="tabpanel"
                ...
                <turbo-frame id="<?= $tab["id"] ?>-frame" loading="lazy" src="<?= $tab["turboUrl"] ?>">
                </turbo-frame>
            </div>
        <?php } ?>
    </div>

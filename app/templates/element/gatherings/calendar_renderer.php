...
/**
 * Dataverse Grid Calendar Renderer
 *
 * @var \App\View\AppView $this
 * @var iterable $data
 * @var array $calendarMeta
 * @var string $viewMode
 */
...
// Remove pagination when building navigation URLs to avoid stale page references
...
<div class="gatherings-calendar" data-controller="gatherings-calendar"
    ...
    <div class="row mb-3 align-items-center">
        ...
        <div class="col-md-6 text-end d-flex justify-content-end gap-2">
            <a class="btn btn-outline-secondary btn-sm" href="<?= $this->Url->build(['action' => 'index']) ?>">
                ...
                <div class="col-auto">
                    <?php if ($prevUrl): ?>
                        <?= $this->Html->link('<i class="bi bi-chevron-left"></i>', $prevUrl, [
                            ...
                            'data-turbo-frame' => 'gatherings-calendar-grid',
                        ]) ?>
                    <?php endif; ?>
                </div>

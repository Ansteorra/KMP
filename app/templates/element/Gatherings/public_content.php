...
Log::debug('Public Content - User set: ' . (isset($user) ? 'yes' : 'no'));
Log::debug('Public Content - User null: ' . ($user === null ? 'yes' : 'no'));
Log::debug('Public Content - Is Authenticated: ' . ($isAuthenticated ? 'yes' : 'no'));
            ...
            <div class="cta-section fade-in">
                ...
                <div style="display: flex; gap: var(--space-md); justify-content: center; flex-wrap: wrap;">
                    <?php if ($isAuthenticated && $canAttend): ?>
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#attendGatheringModal">

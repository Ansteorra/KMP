...
class UpdateOfficersReleaseWorkflowForReplacementStatus extends AbstractMigration
{
    public function up(): void
    {
        ...
        foreach ($definitions as $definition) {
            $definition->description = 'Releases or replaces an officer through the same lifecycle as the '
                . 'legacy manager: stop active window, cancel warrants when required, and send release notification.';

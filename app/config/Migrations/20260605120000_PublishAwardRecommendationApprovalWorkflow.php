...
class PublishAwardRecommendationApprovalWorkflow extends BaseMigration
{
    use CrossEngineMigrationTrait;

    /**
     * Publish the durable recommendation-submitted workflow that starts configured approval processes.
     *
     * @return void
     */

...
class DevSeed extends AbstractSeed
{
    ...
    public function run(): void
    {
        ...
        $insertStatement =
            "INSERT INTO permissions (name, authorization_type_id,system,require_active_membership) SELECT CONCAT('Can Authorize ', authorization_types.name) AS name, authorization_types.id as authorization_type_id, false as system, true as require_active_membership FROM authorization_types";

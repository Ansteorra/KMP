...
<button class="nav-link" id="nav-pending-approvals-tab" data-bs-toggle="tab" data-bs-target="#nav-pending-approvals" type="button" role="tab" aria-controls="nav-pending-approvals" aria-selected="false">Pending</button>
...
<div class="tab-pane fade m-3" id="nav-pending-approvals" role="tabpanel" aria-labelledby="nav-pending-approvals-tab" tabindex="0">
...
<div class="tab-pane fade m-3" id="nav-approved-approvals" role="tabpanel" aria-labelledby="nav-approved-approvals-tab" tabindex="0">
    <div class="table-responsive">
        <table class="table table-striped">
            <thead>
                <tr>
...
<div class="tab-pane fade m-3" id="nav-denied-approvals" role="tabpanel" aria-labelledby="nav-denied-approvals-tab" tabindex="0">
    <div class="table-responsive">
        <table class="table table-striped">
            <thead>
                <tr>

...
/**
 * Table-level authorization policy for Activities.
 *
 ...
 * @see https://github.com/Ansteorra/KMP/blob/main/docs/5.6.5-activity-security-patterns.md For table policy patterns
 */

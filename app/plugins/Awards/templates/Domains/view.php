...
echo $this->KMP->getAppSetting("KMP.ShortSiteTitle") . ': View Award Domain - ' . $domain->name;
$this->KMP->endBlock();
...
<button class="nav-link" id="nav-relatedAwards-tab" data-bs-toggle="tab" data-bs-target="#nav-relatedAwards"
    type="button" role="tab" aria-controls="nav-relatedAwards" aria-selected="false"
    data-detail-tabs-target='tabBtn'><?= __("Related Awards") ?>
</button>
<?php $this->KMP->endBlock() ?>
<?php $this->KMP->startBlock("tabContent") ?>
<div class="related tab-pane fade active m-3" id="nav-relatedAwards" role="tabpanel"
    aria-labelledby="nav-relatedAwards-tab" data-detail-tabs-target="tabContent">
    <?php if (!empty($domain->awards)) { ?>

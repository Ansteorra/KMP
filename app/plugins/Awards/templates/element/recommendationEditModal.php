...
echo $this->Form->create(null, [
    ...
    'data-awards-rec-edit-gatherings-url-value' => $this->URL->build(['controller' => 'Recommendations', 'action' => 'gatheringsForAward', 'plugin' => 'Awards']),
    'data-awards-rec-edit-gatherings-lookup-url-value' => $this->URL->build(['controller' => 'Recommendations', 'action' => 'gatheringsAutoComplete', 'plugin' => 'Awards'])

...
<div class="container-sm">
    <?= $this->Form->create($recommendation, [
        ...
        'data-awards-rec-add-award-list-url-value' => $this->URL->build([
            'controller' => 'Awards',
            'action' => 'awardsByDomain',
            'plugin' => 'Awards',
        ]),
        'data-awards-rec-add-gatherings-url-value' => $this->URL->build([
            'controller' => 'Recommendations',
            'action' => 'gatheringsForAward',
            'plugin' => 'Awards',
        ]),
    ]) ?>
    <div class="card mb-3">
            ...
            <fieldset>
                ...
                <fieldset>
                    ...
                    echo $this->Form->control('contact_email', [
                        'type' => 'email',
                        'help' => 'in case we need to contact you',
                    ]);
                    ...
                    echo $this->KMP->autoCompleteControl(
                        ...
                        [
                            ...
                            'data-action' =>
                                'autocomplete.change->awards-rec-add#loadScaMemberInfo ready->awards-rec-add#acConnected',
                        ],
                    );
                    echo $this->Form->control('not_found', [
                        'type' => 'checkbox',
                        'label' => 'Name not registered in '
                            . $this->KMP->getAppSetting('KMP.ShortSiteTitle') . ' database',
                        'value' => 'on',
                        'disabled' => true,
                    ...
                    echo $this->KMP->comboBoxControl(
                        ...
                        [
                            'data-action' =>
                                'change->awards-rec-add#populateAwardDescriptions ready->awards-rec-add#acConnected',
                        ],
                    ); ?>
                    ...
                    echo $this->KMP->comboBoxControl(
                        ...
                        [
                            ...
                            'data-action' =>
                                'ready->awards-rec-add#acConnected change->awards-rec-add#populateSpecialties',
                        ],
                    );
                    echo $this->KMP->comboBoxControl(
                        $this->Form,
                ...
                <div class="text-end mt-3">
                    <?= $this->Html->link(__('Return to Login'), [
                        'plugin' => null,
                        'controller' => 'Members',
                        'action' => 'login',
                    ], [

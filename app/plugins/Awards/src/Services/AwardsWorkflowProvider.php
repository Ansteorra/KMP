        ...
        WorkflowActionRegistry::register(self::SOURCE, [
            ...
            [
                ...
                'outputSchema' => [
                    ...
                    'closed' => ['type' => 'boolean', 'label' => 'Process Closed'],
                    'recommendationId' => ['type' => 'integer', 'label' => 'Recommendation ID'],
                ],
                'serviceClass' => $actionsClass,
            ...
            [
                'action' => 'Awards.TransitionRecommendation',
                'label' => 'Transition Recommendation',
                'description' => 'Transition an award recommendation through its state machine.',
                'inputSchema' => [
                    'recommendationId' => ['type' => 'integer', 'label' => 'Recommendation ID', 'required' => true],
                ...
                'outputSchema' => [
                    ...
                    'result' => ['type' => 'object', 'label' => 'Transition Result'],
                ],
                'serviceClass' => $actionsClass,
                'serviceMethod' => 'transitionRecommendation',
                'isAsync' => false,
            ],
            [

...
<div id="waiver-upload-step-1"
    data-waiver-upload-wizard-target="step"
    data-step-number="1"
    role="region"
    aria-labelledby="waiver-upload-step-1-heading"
    aria-current="step"
    aria-hidden="false">
    <h3 id="waiver-upload-step-1-heading" class="mb-4">
        ...
        <span aria-hidden="true"><?= __('Step 1: Select Waiver Type') ?></span>
    </h3>
                        ...
                        <div class="me-3">
                            ...
                            <div class="small text-muted">
                                ...
                                <?php if ($hasAttestation) : ?>
                                    <span class="ms-2">
                                        <?= __('Attested: {0}', h(implode(', ', $summary['attestation_reasons']))) ?>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
...
<div id="waiver-upload-step-2"
    data-waiver-upload-wizard-target="step"
    data-step-number="2"
    class="d-none"
    role="region"
    aria-labelledby="waiver-upload-step-2-heading"
    aria-hidden="true">
    <h3 id="waiver-upload-step-2-heading" class="mb-4">
        <i class="bi bi-file-earmark-image text-primary" aria-hidden="true"></i>
        <span class="visually-hidden"><?= __('Step 2 of 3: Add Waiver Pages') ?></span>
        <span aria-hidden="true"><?= __('Step 2: Add Waiver Pages') ?></span>
    </h3>
    ...
    <div class="btn-group w-100 mb-4 d-none" role="group" aria-label="Upload or Attest mode" aria-hidden="true"
        ...
        <div data-controller="file-size-validator"
            ...
            <div class="text-center mb-4">
                <button type="button" class="btn btn-lg btn-primary"
                    aria-describedby="waiver-upload-file-tips"
            ...
            <div id="waiver-upload-file-tips" class="alert alert-info">
                ...
                <ul class="mb-0 mt-2">
                    ...
                    <li><?= __('Images are resized and converted to B&W in your browser when supported') ?></li>
    ...
    <div data-waiver-upload-wizard-target="attestSection" class="d-none" aria-hidden="true">
        <div class="alert alert-info">
            <i class="bi bi-info-circle"></i>
        ...
        <!-- Reason Selection -->
        <fieldset class="mb-3">
            <legend class="form-label fw-bold fs-6"><?= __('Why is this waiver not needed?') ?></legend>
...
<!-- Step 3: Review -->
<div id="waiver-upload-step-3"
    data-waiver-upload-wizard-target="step"
    data-step-number="3"
    class="d-none"
    role="region"
    aria-labelledby="waiver-upload-step-3-heading"
    aria-hidden="true">
    <h3 id="waiver-upload-step-3-heading" class="mb-4">
        <i class="bi bi-check-circle text-success" aria-hidden="true"></i>
        <span class="visually-hidden"><?= __('Step 3 of 3: Review & Submit') ?></span>
        <span aria-hidden="true"><?= __('Step 3: Review & Submit') ?></span>
    </h3>
    ...
    <div data-waiver-upload-wizard-target="reviewAttestSection" class="d-none" aria-hidden="true">
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div data-waiver-upload-wizard-target="reviewAttestNotesSection" class="d-none" aria-hidden="true">
...
<div class="wizard-navigation mt-4 d-flex justify-content-between">
    ...
    <div>
        ...
        <button type="button" class="btn btn-success d-none"
            ...
            <span data-waiver-upload-wizard-target="submitButtonText"><?= __('Submit Waivers') ?></span>
        </button>
    </div>
</div>
</div>

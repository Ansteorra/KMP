 ...
 */
class TemplatePlugin extends BasePlugin implements KMPPluginInterface
{
    /**
    ...
    public function bootstrap(PluginApplicationInterface $app): void
    {
        ...
        NavigationRegistry::register(
            'template',                     // Source identifier for this plugin
    ...
    protected function initializeSettings(): void
    {
        ...
        if ($configVersion != $currentConfigVersion) {
            ...
            StaticHelpers::getAppSetting('Plugin.Template.Active', 'yes', null, true);
            StaticHelpers::getAppSetting('Template.ShowInNavigation', 'yes', null, true);
            StaticHelpers::getAppSetting('Template.HelloWorldMessage', 'Hello, World!', null, true);
        }
    }
}

...
<div class="row">
    <div class="col-md-6 col-12 medium-6 columns">
        ...
        <?php
			...
			?>
        <?php echo $this->element('Queue.yes_no', ['value' => $running]); ?>
        <?php echo $running ? __d('queue', 'Running') : __d('queue', 'Not running'); ?>
        (<?php echo __d('queue', 'last {0}', $this->Time->relLengthOfTime($status['time'])) ?>)
        ...
        <p><?php echo $this->Html->link(__d('queue', 'Detailed Statistics'), ['controller' => 'QueuedJobs', 'action' => 'stats']); ?>
        </p>
        <?php } ?>
    </div>
    ...
    <div class="col-md-6 col-12 medium-6 columns">
        ...
        <ul>
            <li>
                <code>posix</code> extension enabled (optional, recommended):
                <?php echo $this->element('Queue.yes_no', ['value' => function_exists('posix_kill')]); ?>
            </li>
        </ul>

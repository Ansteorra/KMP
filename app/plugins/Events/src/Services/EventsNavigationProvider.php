 ...
 */
class EventsNavigationProvider
{
    /**
     * Get Navigation Items
     *
     * Returns an array of navigation items for the Events plugin.
    ...
    public static function getNavigationItems($user, array $params = []): array
    {
        ...
        $enabled = StaticHelpers::getAppSetting('Plugin.Events.Active', 'yes');

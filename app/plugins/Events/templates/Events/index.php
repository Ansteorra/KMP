...
<div class="helloWorld index content">
    ...
    <div class="alert alert-info" role="alert">
        ...
        <strong>Events Plugin</strong> - This is a demonstration of the KMP plugin system.
        Use this Events as a starting point for your own plugins!
    </div>
    ...
    <div class="mt-4">
        <h3>About This Events</h3>
        <p>This Events plugin demonstrates:</p>
        <ul>
            ...
            <li><strong>Eventss</strong>: Bootstrap-styled views</li>
            <li><strong>Best Practices</strong>: Following KMP conventions</li>
        </ul>
        <p class="text-muted">
            To create your own plugin, copy this Events and customize it for your needs.

...
const STATUS_VERIFIED_MEMBERSHIP = 'verified_membership';
const STATUS_VERIFIED_MINOR = 'verified_minor';
const STATUS_PENDING_MEMBERSHIP = 'pending_membership';
const STATUS_MEMBERSHIP_EXPIRED = 'membership_expired';
const STATUS_BACKGROUND_CHECK_EXPIRED = 'background_check_expired';

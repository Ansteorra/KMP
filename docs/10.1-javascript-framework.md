...
> **Note**: This documentation has been fact-checked against the actual KMP codebase as of December 2025, to ensure accuracy of implementation details, code examples, and configuration.
...
- `window.Controllers["grid-view"] = GridView;` (Dataverse grid system - see [9.1 Dataverse Grid System](9.1-dataverse-grid-system.md))
- `window.Controllers["detail-tabs"] = DetailTabs;` (tab navigation in view pages)

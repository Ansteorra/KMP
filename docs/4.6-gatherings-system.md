...
6. **Advanced Map Features:** Add route planning, nearby amenities, parking information.
7. **Public Registration:** Allow non-authenticated users to pre-register via public landing page.

> 💡 **Implemented since initial release:** Event time customization (datetime support with timezone), cancel/restore workflow, steward editing permissions.

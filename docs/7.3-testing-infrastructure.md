...
| `KINGDOM_BRANCH_ID` | 1 | Root branch (Kingdom of Ansteorra) |
...
| `TEST_BRANCH_LOCAL_ID` | 1073 | Test branch for demo member roles |
...
vendor/bin/phpunit --testsuite waivers
...
├── TestCase/                  # Test cases
│   ├── BaseTestCase.php       # Base class with transaction isolation
...
├── TestDataReference.md       # Test data ID reference
├── Util/                      # Test utilities
│   └── TestDatabaseTrait.php
├── js/                        # JavaScript tests
│   ├── KMP_utils.test.js

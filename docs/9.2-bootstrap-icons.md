...
KMP integrates Bootstrap Icons 1.13.1, a comprehensive icon set with 2000+ SVG icons. Icons provide visual consistency and improve user interface clarity throughout the application.
...
3. **Icon not in set**: Icon name may not be in Bootstrap Icons 1.11

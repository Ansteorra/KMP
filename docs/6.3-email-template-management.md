...
**Location:** `src/Service/MailerDiscoveryService.php`
...
**Location:** `src/Service/EmailTemplateRendererService.php`
...
- **Template Inheritance**: Shared snippets/headers/footers

...
│                    Template Layer                            │
│  ┌─────────────┐  ┌─────────────────┐  ┌─────────────────┐  │
│  │  dv_grid    │  │ dv_grid_content │  │ dv_grid_table   │  │
...
│  ┌─────────────────────────────────────────────────────┐    │
│  │            Entity Controller                         │    │
│  │  - index() - empty, element lazy-loads              │    │
│  │  - gridData() - processes grid requests             │    │
│  └─────────────────────────────────────────────────────┘    │
└─────────────────────────────────────────────────────────────┘
                           │
                           ▼
...
│  ┌─────────────────────────────────────────────────────┐    │
│  │            GridColumns Classes                       │    │
│  │  - Column metadata (type, label, sortable, etc.)    │    │
│  │  - Click actions                                     │    │
...
│                   Frontend Layer                             │
│  ┌─────────────────────────────────────────────────────┐    │
│  │         grid-view-controller.js (Stimulus)          │    │
│  │  - View management                                   │    │
│  │  - Filter/sort state                                 │    │
│  │  - Column picker                                     │    │
│  │  - CSV export                                        │    │
...
| `filterType` | string | Filter UI type: `text`, `dropdown`, `date-range` |
...
| Gatherings | `GatheringTypesGridColumns` | ✅ Complete |
...
For detailed technical documentation, see the implementation docs in `/app/docs/`:

- `DATAVERSE_GRID_IMPLEMENTATION.md` - Complete backend implementation details
- `DATAVERSE_GRID_QUICKSTART.md` - Quick start guide for new grids
- `GRID_STATE_ARCHITECTURE.md` - Frontend state management
- `GRID_MIGRATION_GUIDE.md` - Migration from legacy tables
- `dataverse-grid-feature-flags.md` - Feature flag configuration
- `dataverse-grid-field-naming.md` - Field naming conventions
- `dataverse-toolbar-configuration.md` - Toolbar customization

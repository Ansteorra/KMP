...
Dashboard sections start collapsed and can be expanded by mouse or keyboard. The gathering upload summary distinguishes uploaded documents, exemptions, declined documents, and pending requirements. It shows exemption/decline reasons, the uploader and upload date; decline eligibility appears with the actions. Retention details remain on the individual waiver page. Exemptions do not count as uploaded documents.

...
| `APPINSIGHTS_CONNECTION_STRING` | string | Azure Application Insights connection string used by your log pipeline/collector | `InstrumentationKey=...;IngestionEndpoint=https://...` |
